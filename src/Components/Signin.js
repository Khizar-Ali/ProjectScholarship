          ...
          <form onSubmit={this.handleSubmit}>
            ...
            <div className="form-group">
              ...
              <alert id="col">
                ...
                <br></br>— At least 8 characters, the more characters, the
                better.
                <br></br>— A mixture of both uppercase and lowercase letters.
                <br></br>— A mixture of letters and numbers.
                <br></br>— Inclusion of at least one special character, e.g., !
                @ # ? ]
              </alert>
            </div>
            ...
            <button
              disabled={this.validate(),this.Email="a@gmail.com"}
              id="navcolor"
